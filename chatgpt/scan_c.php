        ...
        <script>
          ...
          function recordTime(qrCodeData) {
            console.log(qrCodeData)
              ...
              xhr.open('POST', 'http://localhost/eas/chatgpt/record_time.php'); // Create a new PHP file for this
              //xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
              window.location.href = 'http://localhost/eas/chatgpt/record_time.php?hash='+qrCodeData;
